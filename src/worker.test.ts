  ...
  describe('tokenize', () => {
    const testCases = [
      ...
      },
      {
        ...
        input: '-.0000000000000000',
        expected: tNumber('-.0000000000000000'),
      },
      {
